...
%1. Data Location
data_location = [main_dir filesep 'derivatives' filesep 'preprocessed' filesep 'eeg' filesep 'exploratory' filesep 'relabeled_for_TF_with_memory'];

%2. Save Data Location
save_location = [main_dir filesep 'derivatives' filesep 'preprocessed' filesep 'eeg' filesep 'exploratory' filesep 'wpli_output_right_frontolat_as_a_seed' filesep 'main' filesep ];

%3. Scripts Location
scripts_location = [main_dir filesep 'code' filesep 'eeg' filesep 'exploratory' filesep 'tf_analyses_with_memory'];
...
Conds = {'resp_i_0_remembered','resp_i_1_remembered', 'resp_c_1_remembered', 'stim_i_0_remembered', 'stim_i_1_remembered', 'resp_i_0_not_remembered','resp_i_1_not_remembered', 'resp_c_1_not_remembered', 'stim_i_0_not_remembered', 'stim_i_1_not_remembered'}; % resp_i_0 = incong error response; resp_i_1 = incong correct response

%8. Minimum number of trials to analyze
mintrialnum = 3; %If the participant does not have enough trials in a condition based on this cutoff, a "notenoughdata.mat" file will be saved into save_location.
...
NumSubsamples = 200; % Kia: My task has 384 trials. So, 125 subsamples seems to be good to cover them all.
