...
save_location = '/home/data/NDClab/datasets/memory-for-error-dataset/derivatives/preprocessed/eeg/exploratory/wpli_output_right_frontolat_as_a_seed/compiled/error/';

plot_save_location = '/home/data/NDClab/datasets/memory-for-error-dataset/derivatives/preprocessed/eeg/exploratory/wpli_output_right_frontolat_as_a_seed/plots/error/';
...
if wPLI_calc==1
    for cond=1:length(ConditionNames)
        ...
        if cond == 1
            saveas(f5,[plot_save_location 'error_rem_wpli_right_lat_to_lateral_occipital.png'])
        elseif cond ==2
            saveas(f5,[plot_save_location 'error_notREM_wpli_right_lat_to_lateral_occipital.png'])
        elseif cond ==3
            saveas(f5,[plot_save_location 'error_diff_wpli_right_lat_to_lateral_occipital.png'])
        end
        ...
        if cond == 1
            saveas(f6,[plot_save_location 'error_rem_wpli_right_lat_to_lateral_occipital_topo.png'])
        elseif cond ==2
            saveas(f6,[plot_save_location 'error_notREM_wpli_right_lat_to_lateral_occipital_topo.png'])
        elseif cond ==3
            saveas(f6,[plot_save_location 'error_diff_wpli_right_lat_to_lateral_occipital_topo.png'])
        end
    end %end loop through conditions
else
end
...
if wPLI_calc==1
    for cond=1:length(ConditionNames)
        ...
        if cond == 1
            saveas(f5,[plot_save_location 'error_rem_wpli_right_lat_to_parietal.png'])
        elseif cond ==2
            saveas(f5,[plot_save_location 'error_notREM_wpli_right_lat_to_parietal.png'])
        elseif cond ==3
            saveas(f5,[plot_save_location 'error_diff_wpli_right_lat_to_parietal.png'])
        end
        ...
        set(gca, 'FontName','Arial', 'FontSize', 14)
        if cond == 1
            saveas(f6,[plot_save_location 'error_rem_wpli_right_lat_to_parietal_topo.png'])
        elseif cond ==2
            saveas(f6,[plot_save_location 'error_notREM_wpli_right_lat_to_parietal_topo.png'])
        elseif cond ==3
            saveas(f6,[plot_save_location 'error_diff_wpli_right_lat_to_parietal_topo.png'])
        end
    end %end loop through conditions
else
end
