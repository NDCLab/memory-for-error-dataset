...
data_location = '/home/data/NDClab/datasets/memory-for-error-dataset/derivatives/preprocessed/eeg/exploratory/TF_outputs_with_memory_conditions/main';
...
save_location = '/home/data/NDClab/datasets/memory-for-error-dataset/derivatives/preprocessed/eeg/exploratory/TF_outputs_with_memory_conditions/compiled/correct/';

plot_save_location = '/home/data/NDClab/datasets/memory-for-error-dataset/derivatives/preprocessed/eeg/exploratory/TF_outputs_with_memory_conditions/plots/correct/';
...
Conds = {'resp_i_1_remembered','resp_i_1_not_remembered'}; %leave blank if resting data

% 6. Name of Conditions to be used for plotting - this such make the order
% that the conditions are named above
ConditionNames = {'correct resp remembered' 'correct resp not remembered'}; %If resting, just put one condition name here (e.g., Resting)
...
%% Kia: Updating ConditionNames as I need to plot the difference in addition to incong correct and incong correct.

ConditionNames = {'correct resp remembered' 'correct resp not remembered' 'Difference correct (REM - NOTREM)'}; 

%% %%%%%%%%%%%%%%% PLOT TF Power for MFC%%%%%%%%%%%%%%%%%%%%%%%
chans2plot_TF = {'1' '2' '34' '33'}; % MFC
...
for cond=1:length(ConditionNames)
    ...
    if Downsample ==1
        ...
        title(['Time Frequency ' ConditionNames(cond) ' mfc'], 'FontName','Times New Roman', 'FontSize', 12, 'FontWeight', 'normal');
    ...
    if cond == 1
        saveas(f4,[plot_save_location 'correct_rem_tf_mfc.png'])
    elseif cond ==2
        saveas(f4,[plot_save_location 'correct_notREM_tf_mfc.png'])
    elseif cond ==3
        saveas(f4,[plot_save_location 'correct_diff_tf_mfc.png'])
    end
    ...
    title(['Time Frequency ' ConditionNames(cond) ' mfc']);
    set(gca, 'FontName','Arial', 'FontSize', 14)

    if cond == 1
        saveas(f3,[plot_save_location 'correct_rem_tf_mfc_topo.png'])
    elseif cond ==2
        saveas(f3,[plot_save_location 'correct_notREM_tf_mfc_topo.png'])
    elseif cond ==3
        saveas(f3,[plot_save_location 'correct_diff_tf_mfc_topo.png'])
    end
end %end loop through 

%% %%%%%%%%%%%%%%% PLOT TF Power for lateral occipital%%%%%%%%%%%%%%%%%%%%%%%
chans2plot_TF = {'22' '53' '24' '55'}; % lateral occipital
...
for cond=1:length(ConditionNames)
    ...
    if Downsample ==1
        contourf(ds_time(time_surface_idx(1,1):time_surface_idx(2,1)), frequency(freq_surface_idx(1,1):freq_surface_idx(2,1)), TF_forTFsurface, 20,'linecolor','none');
        set(gca, 'ylim', freq_window_surface, 'xlim', time_window_surface, 'clim', clim_surface);
        title(['Time Frequency ' ConditionNames(cond) ' lateral occipital'], 'FontName','Times New Roman', 'FontSize', 12, 'FontWeight', 'normal');
        xlabel('Time (ms)'), ylabel('Frequency (Hz)')
        set(findall(gcf,'-property','FontSize'),'FontSize',14)
        set(findall(gcf,'-property','fontname'),'fontname','arial')
        cbar('vert',0, clim_surface, 5);
    ...
    if cond == 1
        saveas(f4,[plot_save_location 'correct_rem_tf_lateral_occipital.png'])
    elseif cond ==2
        saveas(f4,[plot_save_location 'correct_notREM_tf_lateral_occipital.png'])
    elseif cond ==3
        saveas(f4,[plot_save_location 'correct_diff_tf_lateral_occipital.png'])
    end
    ...
    hold on;
    topoplot(TF_fortopo,channel_location,'plotrad',.55,'maplimits',clim_topo,'electrodes','on','numcontour',0);
    title(['Time Frequency ' ConditionNames(cond) ' lateral occipital']);
    set(gca, 'FontName','Arial', 'FontSize', 14)

    if cond == 1
        saveas(f3,[plot_save_location 'correct_rem_tf_lateral_occipital_topo.png'])
    elseif cond ==2
        saveas(f3,[plot_save_location 'correct_notREM_tf_lateral_occipital_topo.png'])
    elseif cond ==3
        saveas(f3,[plot_save_location 'correct_diff_tf_lateral_occipital_topo.png'])
    end
end %end loop through 

%% %%%%%%%%%%%%%%% PLOT TF Power for medial occipital%%%%%%%%%%%%%%%%%%%%%%%
chans2plot_TF = {'19' '23' '50'}; % medial occipital
...
for cond=1:length(ConditionNames)
    ...
    if Downsample ==1
        contourf(ds_time(time_surface_idx(1,1):time_surface_idx(2,1)), frequency(freq_surface_idx(1,1):freq_surface_idx(2,1)), TF_forTFsurface, 20,'linecolor','none');
        set(gca, 'ylim', freq_window_surface, 'xlim', time_window_surface, 'clim', clim_surface);
        title(['Time Frequency ' ConditionNames(cond) 'medial occipital'], 'FontName','Times New Roman', 'FontSize', 12, 'FontWeight', 'normal');
        xlabel('Time (ms)'), ylabel('Frequency (Hz)')
        set(findall(gcf,'-property','FontSize'),'FontSize',14)
        set(findall(gcf,'-property','fontname'),'fontname','arial')
        cbar('vert',0, clim_surface, 5);
    ...
    if cond == 1
        saveas(f4,[plot_save_location 'correct_rem_tf_medial_occipital.png'])
    elseif cond ==2
        saveas(f4,[plot_save_location 'correct_notREM_tf_medial_occipital.png'])
    elseif cond ==3
        saveas(f4,[plot_save_location 'correct_diff_tf_medial_occipital.png'])
    end
    ...
    hold on;
    topoplot(TF_fortopo,channel_location,'plotrad',.55,'maplimits',clim_topo,'electrodes','on','numcontour',0);
    title(['Time Frequency ' ConditionNames(cond) ' medial occipital']);
    set(gca, 'FontName','Arial', 'FontSize', 14)

    if cond == 1
        saveas(f3,[plot_save_location 'correct_rem_tf_medial_occipital_topo.png'])
    elseif cond ==2
        saveas(f3,[plot_save_location 'correct_notREM_tf_medial_occipital_topo.png'])
    elseif cond ==3
        saveas(f3,[plot_save_location 'correct_diff_tf_medial_occipital_topo.png'])
    end
end %end loop through 

%% %%%%%%%%%%%%%%% PLOT TF Power for Parietal%%%%%%%%%%%%%%%%%%%%%%%
chans2plot_TF = {'20' '21' '51' '52'}; % Parietal
...
for cond=1:length(ConditionNames)
    ...
    if Downsample ==1
        contourf(ds_time(time_surface_idx(1,1):time_surface_idx(2,1)), frequency(freq_surface_idx(1,1):freq_surface_idx(2,1)), TF_forTFsurface, 20,'linecolor','none');
        set(gca, 'ylim', freq_window_surface, 'xlim', time_window_surface, 'clim', clim_surface);
        title(['Time Frequency ' ConditionNames(cond) ' parietal'], 'FontName','Times New Roman', 'FontSize', 12, 'FontWeight', 'normal');
        xlabel('Time (ms)'), ylabel('Frequency (Hz)')
        set(findall(gcf,'-property','FontSize'),'FontSize',14)
        set(findall(gcf,'-property','fontname'),'fontname','arial')
        cbar('vert',0, clim_surface, 5);
    ...
    if cond == 1
        saveas(f4,[plot_save_location 'correct_rem_tf_parietal.png'])
    elseif cond ==2
        saveas(f4,[plot_save_location 'correct_notREM_tf_parietal.png'])
    elseif cond ==3
        saveas(f4,[plot_save_location 'correct_diff_tf_parietal.png'])
    end
    ...
    hold on;
    topoplot(TF_fortopo,channel_location,'plotrad',.55,'maplimits',clim_topo,'electrodes','on','numcontour',0);
    title(['Time Frequency ' ConditionNames(cond) ' parietal']);
    set(gca, 'FontName','Arial', 'FontSize', 14)

    if cond == 1
        saveas(f3,[plot_save_location 'correct_rem_tf_parietal_topo.png'])
    elseif cond ==2
        saveas(f3,[plot_save_location 'correct_notREM_tf_parietal_topo.png'])
    elseif cond ==3
        saveas(f3,[plot_save_location 'correct_diff_tf_parietal_topo.png'])
    end
end %end loop through 

%% %%%%%%%%%%%%%%% PLOT TF Power for lateral frontal%%%%%%%%%%%%%%%%%%%%%%%
chans2plot_TF = {'6' '9' '39' '42'}; % lateral frontal
...
for cond=1:length(ConditionNames)
    ...
    if Downsample ==1
        contourf(ds_time(time_surface_idx(1,1):time_surface_idx(2,1)), frequency(freq_surface_idx(1,1):freq_surface_idx(2,1)), TF_forTFsurface, 20,'linecolor','none');
        set(gca, 'ylim', freq_window_surface, 'xlim', time_window_surface, 'clim', clim_surface);
        title(['Time Frequency ' ConditionNames(cond) ' lateral frontal'], 'FontName','Times New Roman', 'FontSize', 12, 'FontWeight', 'normal');
        xlabel('Time (ms)'), ylabel('Frequency (Hz)')
        set(findall(gcf,'-property','FontSize'),'FontSize',14)
        set(findall(gcf,'-property','fontname'),'fontname','arial')
        cbar('vert',0, clim_surface, 5);
    ...
    if cond == 1
        saveas(f4,[plot_save_location 'correct_rem_tf_lateral_frontal.png'])
    elseif cond ==2
        saveas(f4,[plot_save_location 'correct_notREM_tf_lateral_frontal.png'])
    elseif cond ==3
        saveas(f4,[plot_save_location 'correct_diff_tf_lateral_frontal.png'])
    end
    ...
    hold on;
    topoplot(TF_fortopo,channel_location,'plotrad',.55,'maplimits',clim_topo,'electrodes','on','numcontour',0);
    title(['Time Frequency ' ConditionNames(cond) ' lateral frontal']);
    set(gca, 'FontName','Arial', 'FontSize', 14)

    if cond == 1
        saveas(f3,[plot_save_location 'correct_rem_tf_lateral_frontal_topo.png'])
    elseif cond ==2
        saveas(f3,[plot_save_location 'correct_notREM_tf_lateral_frontal_topo.png'])
    elseif cond ==3
        saveas(f3,[plot_save_location 'correct_diff_tf_lateral_frontal_topo.png'])
    end
end %end loop through 



%% frequency and ds_time for ITPS
frequency = ITPS_AllSubs.frequency;
ds_time = ITPS_AllSubs.ds_time;
...
if ITPS_calc==1
    for cond=1:length(ConditionNames)
        ...
        if Downsample ==1
            ...
            set(gca, 'ylim', freq_window_surface, 'xlim', time_window_surface, 'clim', clim_surface);
            title(['ITPS ' ConditionNames(cond) ' MFC'], 'FontName','Times New Roman', 'FontSize', 12, 'FontWeight', 'normal');
            xlabel('Time (ms)'), ylabel('Frequency (Hz)')
            set(findall(gcf,'-property','FontSize'),'FontSize',14)
            set(findall(gcf,'-property','fontname'),'fontname','arial')
            cbar('vert',0, clim_surface, 5);
        ...
        if cond == 1
            saveas(f1,[plot_save_location 'correct_rem_itps_mfc.png'])
        elseif cond ==2
            saveas(f1,[plot_save_location 'correct_notREM_itps_mfc.png'])
        elseif cond ==3
            saveas(f1,[plot_save_location 'correct_diff_itps_mfc.png'])
        end
        ...
        title(['ITPS ' ConditionNames(cond) ' MFC']);
        set(gca, 'FontName','Arial', 'FontSize', 14)
       
        if cond == 1
            saveas(f2,[plot_save_location 'correct_rem_itps_mfc_topo.png'])
        elseif cond ==2
            saveas(f2,[plot_save_location 'correct_notREM_itps_mfc_topo.png'])
        elseif cond ==3
            saveas(f2,[plot_save_location 'correct_diff_itps_mfc_topo.png'])
        end
...
%% %%%%%%%%%%%%%%% PLOT ITPS for lateral occipital %%%%%%%%%%%%%%%%%%%%%%%
% 15. Choose which channels to plot for ITPS surface. (If more than one electrode, then those electrodes will be averaged).    
...
if ITPS_calc==1
    for cond=1:length(ConditionNames)
        ...
        if Downsample ==1
            contourf(ds_time(time_surface_idx(1,1):time_surface_idx(2,1)), frequency(freq_surface_idx(1,1):freq_surface_idx(2,1)), ITPS_forTFsurface, 20,'linecolor','none');
            set(gca, 'ylim', freq_window_surface, 'xlim', time_window_surface, 'clim', clim_surface);
            title(['ITPS ' ConditionNames(cond) ' lateral occipital'], 'FontName','Times New Roman', 'FontSize', 12, 'FontWeight', 'normal');
            xlabel('Time (ms)'), ylabel('Frequency (Hz)')
            set(findall(gcf,'-property','FontSize'),'FontSize',14)
            set(findall(gcf,'-property','fontname'),'fontname','arial')
            cbar('vert',0, clim_surface, 5);
        ...
        if cond == 1
            saveas(f1,[plot_save_location 'correct_rem_itps_lateral_occipital.png'])
        elseif cond ==2
            saveas(f1,[plot_save_location 'correct_notREM_itps_lateral_occipital.png'])
        elseif cond ==3
            saveas(f1,[plot_save_location 'correct_diff_itps_lateral_occipital.png'])
        end
        ...
        hold on;
        topoplot(ITPS_fortopo,channel_location,'plotrad',.55,'maplimits',clim_topo,'electrodes','on','numcontour',0);
        title(['ITPS ' ConditionNames(cond) ' lateral occipital']);
        set(gca, 'FontName','Arial', 'FontSize', 14)
       
        if cond == 1
            saveas(f2,[plot_save_location 'correct_rem_itps_lateral_occipital_topo.png'])
        elseif cond ==2
            saveas(f2,[plot_save_location 'correct_notREM_itps_lateral_occipital_topo.png'])
        elseif cond ==3
            saveas(f2,[plot_save_location 'correct_diff_itps_lateral_occipital_topo.png'])
        end
...
%% %%%%%%%%%%%%%%% PLOT ITPS for medial occipital %%%%%%%%%%%%%%%%%%%%%%%
% 15. Choose which channels to plot for ITPS surface. (If more than one electrode, then those electrodes will be averaged).  
chans2plot_ITPS =  {'19' '23' '50'};  
...
if ITPS_calc==1
    for cond=1:length(ConditionNames)
        ...
        if Downsample ==1
            contourf(ds_time(time_surface_idx(1,1):time_surface_idx(2,1)), frequency(freq_surface_idx(1,1):freq_surface_idx(2,1)), ITPS_forTFsurface, 20,'linecolor','none');
            set(gca, 'ylim', freq_window_surface, 'xlim', time_window_surface, 'clim', clim_surface);
            title(['ITPS ' ConditionNames(cond) ' medial occipital'], 'FontName','Times New Roman', 'FontSize', 12, 'FontWeight', 'normal');
            xlabel('Time (ms)'), ylabel('Frequency (Hz)')
            set(findall(gcf,'-property','FontSize'),'FontSize',14)
            set(findall(gcf,'-property','fontname'),'fontname','arial')
            cbar('vert',0, clim_surface, 5);
        ...
        if cond == 1
            saveas(f1,[plot_save_location 'correct_rem_itps_medial_occipital.png'])
        elseif cond ==2
            saveas(f1,[plot_save_location 'correct_notREM_itps_medial_occipital.png'])
        elseif cond ==3
            saveas(f1,[plot_save_location 'correct_diff_itps_medial_occipital.png'])
        end
        ...
        hold on;
        topoplot(ITPS_fortopo,channel_location,'plotrad',.55,'maplimits',clim_topo,'electrodes','on','numcontour',0);
        title(['ITPS ' ConditionNames(cond) ' medial occipital']);
        set(gca, 'FontName','Arial', 'FontSize', 14)
       
        if cond == 1
            saveas(f2,[plot_save_location 'correct_rem_itps_medial_occipital_topo.png'])
        elseif cond ==2
            saveas(f2,[plot_save_location 'correct_notREM_itps_medial_occipital_topo.png'])
        elseif cond ==3
            saveas(f2,[plot_save_location 'correct_diff_itps_medial_occipital_topo.png'])
        end
...
%% %%%%%%%%%%%%%%% PLOT ITPS for Parietal %%%%%%%%%%%%%%%%%%%%%%%
% 15. Choose which channels to plot for ITPS surface. (If more than one electrode, then those electrodes will be averaged).  
chans2plot_ITPS =  {'20' '21' '51' '52'};  
...
if ITPS_calc==1
    for cond=1:length(ConditionNames)
        ...
        if Downsample ==1
            contourf(ds_time(time_surface_idx(1,1):time_surface_idx(2,1)), frequency(freq_surface_idx(1,1):freq_surface_idx(2,1)), ITPS_forTFsurface, 20,'linecolor','none');
            set(gca, 'ylim', freq_window_surface, 'xlim', time_window_surface, 'clim', clim_surface);
            title(['ITPS ' ConditionNames(cond) ' parietal'], 'FontName','Times New Roman', 'FontSize', 12, 'FontWeight', 'normal');
            xlabel('Time (ms)'), ylabel('Frequency (Hz)')
            set(findall(gcf,'-property','FontSize'),'FontSize',14)
            set(findall(gcf,'-property','fontname'),'fontname','arial')
            cbar('vert',0, clim_surface, 5);
        ...
        if cond == 1
            saveas(f1,[plot_save_location 'correct_rem_itps_parietal.png'])
        elseif cond ==2
            saveas(f1,[plot_save_location 'correct_notREM_itps_parietal.png'])
        elseif cond ==3
            saveas(f1,[plot_save_location 'correct_diff_itps_parietal.png'])
        end
        ...
        hold on;
        topoplot(ITPS_fortopo,channel_location,'plotrad',.55,'maplimits',clim_topo,'electrodes','on','numcontour',0);
        title(['ITPS ' ConditionNames(cond) ' parietal']);
        set(gca, 'FontName','Arial', 'FontSize', 14)
       
        if cond == 1
            saveas(f2,[plot_save_location 'correct_rem_itps_parietal_topo.png'])
        elseif cond ==2
            saveas(f2,[plot_save_location 'correct_notREM_itps_parietal_topo.png'])
        elseif cond ==3
            saveas(f2,[plot_save_location 'correct_diff_itps_parietal_topo.png'])
        end
...
%% %%%%%%%%%%%%%%% PLOT ITPS for Lateral Frontal %%%%%%%%%%%%%%%%%%%%%%%
% 15. Choose which channels to plot for ITPS surface. (If more than one electrode, then those electrodes will be averaged).  
chans2plot_ITPS =  {'6' '9' '39' '42'};  % lateral frontal
...
if ITPS_calc==1
    for cond=1:length(ConditionNames)
        ...
        if Downsample ==1
            contourf(ds_time(time_surface_idx(1,1):time_surface_idx(2,1)), frequency(freq_surface_idx(1,1):freq_surface_idx(2,1)), ITPS_forTFsurface, 20,'linecolor','none');
            set(gca, 'ylim', freq_window_surface, 'xlim', time_window_surface, 'clim', clim_surface);
            title(['ITPS ' ConditionNames(cond) ' lateral frontal'], 'FontName','Times New Roman', 'FontSize', 12, 'FontWeight', 'normal');
            xlabel('Time (ms)'), ylabel('Frequency (Hz)')
            set(findall(gcf,'-property','FontSize'),'FontSize',14)
            set(findall(gcf,'-property','fontname'),'fontname','arial')
            cbar('vert',0, clim_surface, 5);
        ...
        if cond == 1
            saveas(f1,[plot_save_location 'correct_rem_itps_lateral_frontal.png'])
        elseif cond ==2
            saveas(f1,[plot_save_location 'correct_notREM_itps_lateral_frontal.png'])
        elseif cond ==3
            saveas(f1,[plot_save_location 'correct_diff_itps_lateral_frontal.png'])
        end
        ...
        hold on;
        topoplot(ITPS_fortopo,channel_location,'plotrad',.55,'maplimits',clim_topo,'electrodes','on','numcontour',0);
        title(['ITPS ' ConditionNames(cond) ' lateral frontal']);
        set(gca, 'FontName','Arial', 'FontSize', 14)
       
        if cond == 1
            saveas(f2,[plot_save_location 'correct_rem_itps_lateral_frontal_topo.png'])
        elseif cond ==2
            saveas(f2,[plot_save_location 'correct_notREM_itps_lateral_frontal_topo.png'])
        elseif cond ==3
            saveas(f2,[plot_save_location 'correct_diff_itps_lateral_frontal_topo.png'])
        end
...
if wPLI_calc==1
    for cond=1:length(ConditionNames)
        ...
        if cond == 1
            saveas(f5,[plot_save_location 'correct_rem_wpli_lateral_occipital.png'])
        elseif cond ==2
            saveas(f5,[plot_save_location 'correct_notREM_wpli_lateral_occipital.png'])
        elseif cond ==3
            saveas(f5,[plot_save_location 'correct_diff_wpli_lateral_occipital.png'])
        end
        ...
        set(gca, 'FontName','Arial', 'FontSize', 14)
        if cond == 1
            saveas(f6,[plot_save_location 'correct_rem_wpli_lateral_occipital_topo.png'])
        elseif cond ==2
            saveas(f6,[plot_save_location 'correct_notREM_wpli_lateral_occipital_topo.png'])
        elseif cond ==3
            saveas(f6,[plot_save_location 'correct_diff_wpli_lateral_occipital_topo.png'])
        end
    end %end loop through conditions
else
end

%% %%%%%%%%%%%%%%% PLOT CONNECTIVITY (MFC-Medial Occipital) %%%%%%%%%%%%%%%%%%%%%%%

% Choose plotting parameters for ICPS and wPLI 
% Choose which channels to plot. NOTE: This should not include the seed.
% The seed is electrode "1" (i.e., 1). 
chans2plot_ICPSwpli = {'19' '50' '23'}; % medial occipital
...
if wPLI_calc==1
    for cond=1:length(ConditionNames)
        ...
        if Downsample ==1
            contourf(ds_time(time_surface_idx(1,1):time_surface_idx(2,1)), frequency(freq_surface_idx(1,1):freq_surface_idx(2,1)), wpli_forTFsurface, 20,'linecolor','none');
            set(gca, 'ylim', freq_window_surface, 'xlim', time_window_surface, 'clim', clim_surface);
            title(['wPLI ' ConditionNames(cond) ' Medial Occipital'], 'FontName','Times New Roman', 'FontSize', 12, 'FontWeight', 'normal');
            xlabel('Time (ms)'), ylabel('Frequency (Hz)')
            set(findall(gcf,'-property','FontSize'),'FontSize',14)
            set(findall(gcf,'-property','fontname'),'fontname','arial')
            cbar('vert',0, clim_surface, 5);
        ...
        if cond == 1
            saveas(f5,[plot_save_location 'correct_rem_wpli_medial_occipital.png'])
        elseif cond ==2
            saveas(f5,[plot_save_location 'correct_notREM_wpli_medial_occipital.png'])
        elseif cond ==3
            saveas(f5,[plot_save_location 'correct_diff_wpli_medial_occipital.png'])
        end
        ...
        hold on;
        topoplot(wpli_fortopo,channel_location,'plotrad',.55,'maplimits',clim_topo,'electrodes','on','numcontour',0);
        title(['wPLI ' ConditionNames(cond) ' medial occipital']);
        set(gca, 'FontName','Arial', 'FontSize', 14)
        if cond == 1
            saveas(f6,[plot_save_location 'correct_rem_wpli_medial_occipital_topo.png'])
        elseif cond ==2
            saveas(f6,[plot_save_location 'correct_notREM_wpli_medial_occipital_topo.png'])
        elseif cond ==3
            saveas(f6,[plot_save_location 'correct_diff_wpli_medial_occipital_topo.png'])
        end
    end %end loop through conditions
else
end
...
if wPLI_calc==1
    for cond=1:length(ConditionNames)
        ...
        if cond == 1
            saveas(f5,[plot_save_location 'correct_rem_wpli_parietal.png'])
        elseif cond ==2
            saveas(f5,[plot_save_location 'correct_notREM_wpli_parietal.png'])
        elseif cond ==3
            saveas(f5,[plot_save_location 'correct_diff_wpli_parietal.png'])
        end
        ...
        set(gca, 'FontName','Arial', 'FontSize', 14)
        if cond == 1
            saveas(f6,[plot_save_location 'correct_rem_wpli_parietal_topo.png'])
        elseif cond ==2
            saveas(f6,[plot_save_location 'correct_notREM_wpli_parietal_topo.png'])
        elseif cond ==3
            saveas(f6,[plot_save_location 'correct_diff_wpli_parietal_topo.png'])
        end
    end %end loop through conditions
else
end
...
%% %%%%%%%%%%%%%%% PLOT CONNECTIVITY (MFC-Lateral Frontal) %%%%%%%%%%%%%%%%%%%%%%%

% Choose plotting parameters for ICPS and wPLI 
% Choose which channels to plot. NOTE: This should not include the seed.
% The seed is electrode "1" (i.e., 1). 
chans2plot_ICPSwpli = {'6' '9' '39' '42'}; % lateral frontal
...
if wPLI_calc==1
    for cond=1:length(ConditionNames)
        ...
        if Downsample ==1
            contourf(ds_time(time_surface_idx(1,1):time_surface_idx(2,1)), frequency(freq_surface_idx(1,1):freq_surface_idx(2,1)), wpli_forTFsurface, 20,'linecolor','none');
            set(gca, 'ylim', freq_window_surface, 'xlim', time_window_surface, 'clim', clim_surface);
            title(['wPLI ' ConditionNames(cond) ' lateral frontal'], 'FontName','Times New Roman', 'FontSize', 12, 'FontWeight', 'normal');
            xlabel('Time (ms)'), ylabel('Frequency (Hz)')
            set(findall(gcf,'-property','FontSize'),'FontSize',14)
            set(findall(gcf,'-property','fontname'),'fontname','arial')
            cbar('vert',0, clim_surface, 5);
        ...
        if cond == 1
            saveas(f5,[plot_save_location 'correct_rem_wpli_lateral_frontal.png'])
        elseif cond ==2
            saveas(f5,[plot_save_location 'correct_notREM_wpli_lateral_frontal.png'])
        elseif cond ==3
            saveas(f5,[plot_save_location 'correct_diff_wpli_lateral_frontal.png'])
        end
        ...
        hold on;
        topoplot(wpli_fortopo,channel_location,'plotrad',.55,'maplimits',clim_topo,'electrodes','on','numcontour',0);
        title(['wPLI ' ConditionNames(cond) ' lateral frontal']);
        set(gca, 'FontName','Arial', 'FontSize', 14)
        if cond == 1
            saveas(f6,[plot_save_location 'correct_rem_wpli_lateral_frontal_topo.png'])
        elseif cond ==2
            saveas(f6,[plot_save_location 'correct_notREM_wpli_lateral_frontal_topo.png'])
        elseif cond ==3
            saveas(f6,[plot_save_location 'correct_diff_wpli_lateral_frontal_topo.png'])
        end
    end %end loop through conditions
else
end
