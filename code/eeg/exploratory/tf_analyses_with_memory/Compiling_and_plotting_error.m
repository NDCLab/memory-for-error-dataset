...
save_location = '/home/data/NDClab/datasets/memory-for-error-dataset/derivatives/preprocessed/eeg/exploratory/TF_outputs_with_memory_conditions/compiled/error/';

plot_save_location = '/home/data/NDClab/datasets/memory-for-error-dataset/derivatives/preprocessed/eeg/exploratory/TF_outputs_with_memory_conditions/plots/error/';
...
for cond=1:length(ConditionNames)
    ...
    if cond == 1
        saveas(f4,[plot_save_location 'error_rem_tf_mfc.png'])
    elseif cond ==2
        saveas(f4,[plot_save_location 'error_notREM_tf_mfc.png'])
    elseif cond ==3
        saveas(f4,[plot_save_location 'error_diff_tf_mfc.png'])
    end
    ...
    if cond == 1
        saveas(f3,[plot_save_location 'error_rem_tf_mfc_topo.png'])
    elseif cond ==2
        saveas(f3,[plot_save_location 'error_notREM_tf_mfc_topo.png'])
    elseif cond ==3
        saveas(f3,[plot_save_location 'error_diff_tf_mfc_topo.png'])
    end
...
for cond=1:length(ConditionNames)
    ...
    if cond == 1
        saveas(f4,[plot_save_location 'error_rem_tf_lateral_occipital.png'])
    elseif cond ==2
        saveas(f4,[plot_save_location 'error_notREM_tf_lateral_occipital.png'])
    elseif cond ==3
        saveas(f4,[plot_save_location 'error_diff_tf_lateral_occipital.png'])
    end
    ...
    if cond == 1
        saveas(f3,[plot_save_location 'error_rem_tf_lateral_occipital_topo.png'])
    elseif cond ==2
        saveas(f3,[plot_save_location 'error_notREM_tf_lateral_occipital_topo.png'])
    elseif cond ==3
        saveas(f3,[plot_save_location 'error_diff_tf_lateral_occipital_topo.png'])
    end
end %end loop through 
...
for cond=1:length(ConditionNames)
    ...
    if cond == 1
        saveas(f4,[plot_save_location 'error_rem_tf_medial_occipital.png'])
    elseif cond ==2
        saveas(f4,[plot_save_location 'error_notREM_tf_medial_occipital.png'])
    elseif cond ==3
        saveas(f4,[plot_save_location 'error_diff_tf_medial_occipital.png'])
    end
    ...
    if cond == 1
        saveas(f3,[plot_save_location 'error_rem_tf_medial_occipital_topo.png'])
    elseif cond ==2
        saveas(f3,[plot_save_location 'error_notREM_tf_medial_occipital_topo.png'])
    elseif cond ==3
        saveas(f3,[plot_save_location 'error_diff_tf_medial_occipital_topo.png'])
    end
end %end loop through 
...
for cond=1:length(ConditionNames)
    ...
    if cond == 1
        saveas(f4,[plot_save_location 'error_rem_tf_parietal.png'])
    elseif cond ==2
        saveas(f4,[plot_save_location 'error_notREM_tf_parietal.png'])
    elseif cond ==3
        saveas(f4,[plot_save_location 'error_diff_tf_parietal.png'])
    end
    ...
    if cond == 1
        saveas(f3,[plot_save_location 'error_rem_tf_parietal_topo.png'])
    elseif cond ==2
        saveas(f3,[plot_save_location 'error_notREM_tf_parietal_topo.png'])
    elseif cond ==3
        saveas(f3,[plot_save_location 'error_diff_tf_parietal_topo.png'])
    end
end %end loop through 
...
for cond=1:length(ConditionNames)
    ...
    if cond == 1
        saveas(f4,[plot_save_location 'error_rem_tf_lateral_frontal.png'])
    elseif cond ==2
        saveas(f4,[plot_save_location 'error_notREM_tf_lateral_frontal.png'])
    elseif cond ==3
        saveas(f4,[plot_save_location 'error_diff_tf_lateral_frontal.png'])
    end
    ...
    if cond == 1
        saveas(f3,[plot_save_location 'error_rem_tf_lateral_frontal_topo.png'])
    elseif cond ==2
        saveas(f3,[plot_save_location 'error_notREM_tf_lateral_frontal_topo.png'])
    elseif cond ==3
        saveas(f3,[plot_save_location 'error_diff_tf_lateral_frontal_topo.png'])
    end
end %end loop through 
...
if ITPS_calc==1
    for cond=1:length(ConditionNames)
        ...
        if cond == 1
            saveas(f1,[plot_save_location 'error_rem_itps_mfc.png'])
        elseif cond ==2
            saveas(f1,[plot_save_location 'error_notREM_itps_mfc.png'])
        elseif cond ==3
            saveas(f1,[plot_save_location 'error_diff_itps_mfc.png'])
        end
        ...
        if cond == 1
            saveas(f2,[plot_save_location 'error_rem_itps_mfc_topo.png'])
        elseif cond ==2
            saveas(f2,[plot_save_location 'error_notREM_itps_mfc_topo.png'])
        elseif cond ==3
            saveas(f2,[plot_save_location 'error_diff_itps_mfc_topo.png'])
        end
...
if ITPS_calc==1
    for cond=1:length(ConditionNames)
        ...
        if cond == 1
            saveas(f1,[plot_save_location 'error_rem_itps_lateral_occipital.png'])
        elseif cond ==2
            saveas(f1,[plot_save_location 'error_notREM_itps_lateral_occipital.png'])
        elseif cond ==3
            saveas(f1,[plot_save_location 'error_diff_itps_lateral_occipital.png'])
        end
        ...
        if cond == 1
            saveas(f2,[plot_save_location 'error_rem_itps_lateral_occipital_topo.png'])
        elseif cond ==2
            saveas(f2,[plot_save_location 'error_notREM_itps_lateral_occipital_topo.png'])
        elseif cond ==3
            saveas(f2,[plot_save_location 'error_diff_itps_lateral_occipital_topo.png'])
        end
...
if ITPS_calc==1
    for cond=1:length(ConditionNames)
        ...
        if cond == 1
            saveas(f1,[plot_save_location 'error_rem_itps_medial_occipital.png'])
        elseif cond ==2
            saveas(f1,[plot_save_location 'error_notREM_itps_medial_occipital.png'])
        elseif cond ==3
            saveas(f1,[plot_save_location 'error_diff_itps_medial_occipital.png'])
        end
        ...
        if cond == 1
            saveas(f2,[plot_save_location 'error_rem_itps_medial_occipital_topo.png'])
        elseif cond ==2
            saveas(f2,[plot_save_location 'error_notREM_itps_medial_occipital_topo.png'])
        elseif cond ==3
            saveas(f2,[plot_save_location 'error_diff_itps_medial_occipital_topo.png'])
        end
...
if ITPS_calc==1
    for cond=1:length(ConditionNames)
        ...
        if cond == 1
            saveas(f1,[plot_save_location 'error_rem_itps_parietal.png'])
        elseif cond ==2
            saveas(f1,[plot_save_location 'error_notREM_itps_parietal.png'])
        elseif cond ==3
            saveas(f1,[plot_save_location 'error_diff_itps_parietal.png'])
        end
        ...
        if cond == 1
            saveas(f2,[plot_save_location 'error_rem_itps_parietal_topo.png'])
        elseif cond ==2
            saveas(f2,[plot_save_location 'error_notREM_itps_parietal_topo.png'])
        elseif cond ==3
            saveas(f2,[plot_save_location 'error_diff_itps_parietal_topo.png'])
        end
...
if ITPS_calc==1
    for cond=1:length(ConditionNames)
        ...
        if cond == 1
            saveas(f1,[plot_save_location 'error_rem_itps_lateral_frontal.png'])
        elseif cond ==2
            saveas(f1,[plot_save_location 'error_notREM_itps_lateral_frontal.png'])
        elseif cond ==3
            saveas(f1,[plot_save_location 'error_diff_itps_lateral_frontal.png'])
        end
        ...
        if cond == 1
            saveas(f2,[plot_save_location 'error_rem_itps_lateral_frontal_topo.png'])
        elseif cond ==2
            saveas(f2,[plot_save_location 'error_notREM_itps_lateral_frontal_topo.png'])
        elseif cond ==3
            saveas(f2,[plot_save_location 'error_diff_itps_lateral_frontal_topo.png'])
        end
...
if wPLI_calc==1
    for cond=1:length(ConditionNames)
        ...
        if cond == 1
            saveas(f5,[plot_save_location 'error_rem_wpli_lateral_occipital.png'])
        elseif cond ==2
            saveas(f5,[plot_save_location 'error_notREM_wpli_lateral_occipital.png'])
        elseif cond ==3
            saveas(f5,[plot_save_location 'error_diff_wpli_lateral_occipital.png'])
        end
        ...
        set(gca, 'FontName','Arial', 'FontSize', 14)
        if cond == 1
            saveas(f6,[plot_save_location 'error_rem_wpli_lateral_occipital_topo.png'])
        elseif cond ==2
            saveas(f6,[plot_save_location 'error_notREM_wpli_lateral_occipital_topo.png'])
        elseif cond ==3
            saveas(f6,[plot_save_location 'error_diff_wpli_lateral_occipital_topo.png'])
        end
    end %end loop through conditions
else
end
...
if wPLI_calc==1
    for cond=1:length(ConditionNames)
        ...
        if cond == 1
            saveas(f5,[plot_save_location 'error_rem_wpli_medial_occipital.png'])
        elseif cond ==2
            saveas(f5,[plot_save_location 'error_notREM_wpli_medial_occipital.png'])
        elseif cond ==3
            saveas(f5,[plot_save_location 'error_diff_wpli_medial_occipital.png'])
        end
        ...
        set(gca, 'FontName','Arial', 'FontSize', 14)
        if cond == 1
            saveas(f6,[plot_save_location 'error_rem_wpli_medial_occipital_topo.png'])
        elseif cond ==2
            saveas(f6,[plot_save_location 'error_notREM_wpli_medial_occipital_topo.png'])
        elseif cond ==3
            saveas(f6,[plot_save_location 'error_diff_wpli_medial_occipital_topo.png'])
        end
    end %end loop through conditions
else
end
...
if wPLI_calc==1
    for cond=1:length(ConditionNames)
        ...
        if cond == 1
            saveas(f5,[plot_save_location 'error_rem_wpli_parietal.png'])
        elseif cond ==2
            saveas(f5,[plot_save_location 'error_notREM_wpli_parietal.png'])
        elseif cond ==3
            saveas(f5,[plot_save_location 'error_diff_wpli_parietal.png'])
        end
        ...
        set(gca, 'FontName','Arial', 'FontSize', 14)
        if cond == 1
            saveas(f6,[plot_save_location 'error_rem_wpli_parietal_topo.png'])
        elseif cond ==2
            saveas(f6,[plot_save_location 'error_notREM_wpli_parietal_topo.png'])
        elseif cond ==3
            saveas(f6,[plot_save_location 'error_diff_wpli_parietal_topo.png'])
        end
    end %end loop through conditions
else
end
...
if wPLI_calc==1
    for cond=1:length(ConditionNames)
        ...
        if cond == 1
            saveas(f5,[plot_save_location 'error_rem_wpli_lateral_frontal.png'])
        elseif cond ==2
            saveas(f5,[plot_save_location 'error_notREM_wpli_lateral_frontal.png'])
        elseif cond ==3
            saveas(f5,[plot_save_location 'error_diff_wpli_lateral_frontal.png'])
        end
        ...
        set(gca, 'FontName','Arial', 'FontSize', 14)
        if cond == 1
            saveas(f6,[plot_save_location 'error_rem_wpli_lateral_frontal_topo.png'])
        elseif cond ==2
            saveas(f6,[plot_save_location 'error_notREM_wpli_lateral_frontal_topo.png'])
        elseif cond ==3
            saveas(f6,[plot_save_location 'error_diff_wpli_lateral_frontal_topo.png'])
        end
    end %end loop through conditions
else
end
