...
%1. Data Location
data_location = [main_dir filesep 'derivatives' filesep 'preprocessed' filesep 'eeg' filesep 'relabeled_for_TF_with_memory'];

%2. Save Data Location
save_location = [main_dir filesep 'derivatives' filesep 'preprocessed' filesep 'eeg' filesep 'exploratory' filesep 'TF_outputs_with_memory_conditions' filesep 'main' filesep ];
