...
% Kia Hosseini edited this script for the mfe_b study in July, 2024.
...
data_location = '/Users/kihossei/Documents/GitHub/memory-for-error-dataset/derivatives/preprocessed/eeg/TF_outputs/main';
...
save_location = '/home/data/NDClab/datasets/memory-for-error-dataset/derivatives/preprocessed/eeg/TF_outputs/compiled/';

plot_save_location = '/home/data/NDClab/datasets/memory-for-error-dataset/derivatives/preprocessed/eeg/TF_outputs/plots/';
...
% Channel locations
channel_location = TF_AllSubs.channel_location; 
...
%% frequency and ds_time for TF
frequency = TF_AllSubs.frequency;
ds_time = TF_AllSubs.ds_time;
...
for cond=1:length(ConditionNames)
    ...
    if cond == 1
        saveas(f4,[plot_save_location 'error_tf_mfc.png'])
    elseif cond ==2
        saveas(f4,[plot_save_location 'correct_tf_mfc.png'])
    elseif cond ==3
        saveas(f4,[plot_save_location 'diff_tf_mfc.png'])
    end
    ...
    if cond == 1
        saveas(f3,[plot_save_location 'error_tf_mfc_topo.png'])
    elseif cond ==2
        saveas(f3,[plot_save_location 'correct_tf_mfc_topo.png'])
    elseif cond ==3
        saveas(f3,[plot_save_location 'diff_tf_mfc_topo.png'])
    end
...
for cond=1:length(ConditionNames)
    ...
    if cond == 1
        saveas(f4,[plot_save_location 'error_tf_lateral_occipital.png'])
    elseif cond ==2
        saveas(f4,[plot_save_location 'correct_tf_lateral_occipital.png'])
    elseif cond ==3
        saveas(f4,[plot_save_location 'diff_tf_lateral_occipital.png'])
    end
    ...
    if cond == 1
        saveas(f3,[plot_save_location 'error_tf_lateral_occipital_topo.png'])
    elseif cond ==2
        saveas(f3,[plot_save_location 'correct_tf_lateral_occipital_topo.png'])
    elseif cond ==3
        saveas(f3,[plot_save_location 'diff_tf_lateral_occipital_topo.png'])
    end
end %end loop through 
...
for cond=1:length(ConditionNames)
    ...
    if cond == 1
        saveas(f4,[plot_save_location 'error_tf_medial_occipital.png'])
    elseif cond ==2
        saveas(f4,[plot_save_location 'correct_tf_medial_occipital.png'])
    elseif cond ==3
        saveas(f4,[plot_save_location 'diff_tf_medial_occipital.png'])
    end
    ...
    if cond == 1
        saveas(f3,[plot_save_location 'error_tf_medial_occipital_topo.png'])
    elseif cond ==2
        saveas(f3,[plot_save_location 'correct_tf_medial_occipital_topo.png'])
    elseif cond ==3
        saveas(f3,[plot_save_location 'diff_tf_medial_occipital_topo.png'])
    end
end %end loop through 
...
for cond=1:length(ConditionNames)
    ...
    if cond == 1
        saveas(f4,[plot_save_location 'error_tf_parietal.png'])
    elseif cond ==2
        saveas(f4,[plot_save_location 'correct_tf_parietal.png'])
    elseif cond ==3
        saveas(f4,[plot_save_location 'diff_tf_parietal.png'])
    end
    ...
    if cond == 1
        saveas(f3,[plot_save_location 'error_tf_parietal_topo.png'])
    elseif cond ==2
        saveas(f3,[plot_save_location 'correct_tf_parietal_topo.png'])
    elseif cond ==3
        saveas(f3,[plot_save_location 'diff_tf_parietal_topo.png'])
    end
end %end loop through 
...
for cond=1:length(ConditionNames)
    ...
    if cond == 1
        saveas(f4,[plot_save_location 'error_tf_lateral_frontal.png'])
    elseif cond ==2
        saveas(f4,[plot_save_location 'correct_tf_lateral_frontal.png'])
    elseif cond ==3
        saveas(f4,[plot_save_location 'diff_tf_lateral_frontal.png'])
    end
    ...
    if cond == 1
        saveas(f3,[plot_save_location 'error_tf_lateral_frontal_topo.png'])
    elseif cond ==2
        saveas(f3,[plot_save_location 'correct_tf_lateral_frontal_topo.png'])
    elseif cond ==3
        saveas(f3,[plot_save_location 'diff_tf_lateral_frontal_topo.png'])
    end
end %end loop through 
...
if ITPS_calc==1
    for cond=1:length(ConditionNames)
        ...
        if cond == 1
            saveas(f1,[plot_save_location 'error_itps_mfc.png'])
        elseif cond ==2
            saveas(f1,[plot_save_location 'correct_itps_mfc.png'])
        elseif cond ==3
            saveas(f1,[plot_save_location 'diff_itps_mfc.png'])
        end
        ...
        if cond == 1
            saveas(f2,[plot_save_location 'error_itps_mfc_topo.png'])
        elseif cond ==2
            saveas(f2,[plot_save_location 'correct_itps_mfc_topo.png'])
        elseif cond ==3
            saveas(f2,[plot_save_location 'diff_itps_mfc_topo.png'])
        end
...
if ITPS_calc==1
    for cond=1:length(ConditionNames)
        ...
        if cond == 1
            saveas(f1,[plot_save_location 'error_itps_lateral_occipital.png'])
        elseif cond ==2
            saveas(f1,[plot_save_location 'correct_itps_lateral_occipital.png'])
        elseif cond ==3
            saveas(f1,[plot_save_location 'diff_itps_lateral_occipital.png'])
        end
        ...
        if cond == 1
            saveas(f2,[plot_save_location 'error_itps_lateral_occipital_topo.png'])
        elseif cond ==2
            saveas(f2,[plot_save_location 'correct_itps_lateral_occipital_topo.png'])
        elseif cond ==3
            saveas(f2,[plot_save_location 'diff_itps_lateral_occipital_topo.png'])
        end
...
if ITPS_calc==1
    for cond=1:length(ConditionNames)
        ...
        if cond == 1
            saveas(f1,[plot_save_location 'error_itps_medial_occipital.png'])
        elseif cond ==2
            saveas(f1,[plot_save_location 'correct_itps_medial_occipital.png'])
        elseif cond ==3
            saveas(f1,[plot_save_location 'diff_itps_medial_occipital.png'])
        end
        ...
        if cond == 1
            saveas(f2,[plot_save_location 'error_itps_medial_occipital_topo.png'])
        elseif cond ==2
            saveas(f2,[plot_save_location 'correct_itps_medial_occipital_topo.png'])
        elseif cond ==3
            saveas(f2,[plot_save_location 'diff_itps_medial_occipital_topo.png'])
        end
...
if ITPS_calc==1
    for cond=1:length(ConditionNames)
        ...
        if cond == 1
            saveas(f1,[plot_save_location 'error_itps_parietal.png'])
        elseif cond ==2
            saveas(f1,[plot_save_location 'correct_itps_parietal.png'])
        elseif cond ==3
            saveas(f1,[plot_save_location 'diff_itps_parietal.png'])
        end
        ...
        if cond == 1
            saveas(f2,[plot_save_location 'error_itps_parietal_topo.png'])
        elseif cond ==2
            saveas(f2,[plot_save_location 'correct_itps_parietal_topo.png'])
        elseif cond ==3
            saveas(f2,[plot_save_location 'diff_itps_parietal_topo.png'])
        end
...
if ITPS_calc==1
    for cond=1:length(ConditionNames)
        ...
        if cond == 1
            saveas(f1,[plot_save_location 'error_itps_lateral_frontal.png'])
        elseif cond ==2
            saveas(f1,[plot_save_location 'correct_itps_lateral_frontal.png'])
        elseif cond ==3
            saveas(f1,[plot_save_location 'diff_itps_lateral_frontal.png'])
        end
        ...
        if cond == 1
            saveas(f2,[plot_save_location 'error_itps_lateral_frontal_topo.png'])
        elseif cond ==2
            saveas(f2,[plot_save_location 'correct_itps_lateral_frontal_topo.png'])
        elseif cond ==3
            saveas(f2,[plot_save_location 'diff_itps_lateral_frontal_topo.png'])
        end
...
if wPLI_calc==1
    for cond=1:length(ConditionNames)
        ...
        if cond == 1
            saveas(f5,[plot_save_location 'error_wpli_lateral_occipital.png'])
        elseif cond ==2
            saveas(f5,[plot_save_location 'correct_wpli_lateral_occipital.png'])
        elseif cond ==3
            saveas(f5,[plot_save_location 'diff_wpli_lateral_occipital.png'])
        end
        ...
        set(gca, 'FontName','Arial', 'FontSize', 14)
        if cond == 1
            saveas(f6,[plot_save_location 'error_wpli_lateral_occipital_topo.png'])
        elseif cond ==2
            saveas(f6,[plot_save_location 'correct_wpli_lateral_occipital_topo.png'])
        elseif cond ==3
            saveas(f6,[plot_save_location 'diff_wpli_lateral_occipital_topo.png'])
        end
    end %end loop through conditions
else
end
...
if wPLI_calc==1
    for cond=1:length(ConditionNames)
        ...
        if cond == 1
            saveas(f5,[plot_save_location 'error_wpli_medial_occipital.png'])
        elseif cond ==2
            saveas(f5,[plot_save_location 'correct_wpli_medial_occipital.png'])
        elseif cond ==3
            saveas(f5,[plot_save_location 'diff_wpli_medial_occipital.png'])
        end
        ...
        set(gca, 'FontName','Arial', 'FontSize', 14)
        if cond == 1
            saveas(f6,[plot_save_location 'error_wpli_medial_occipital_topo.png'])
        elseif cond ==2
            saveas(f6,[plot_save_location 'correct_wpli_medial_occipital_topo.png'])
        elseif cond ==3
            saveas(f6,[plot_save_location 'diff_wpli_medial_occipital_topo.png'])
        end
    end %end loop through conditions
else
end
...
if wPLI_calc==1
    for cond=1:length(ConditionNames)
        ...
        if cond == 1
            saveas(f5,[plot_save_location 'error_wpli_parietal.png'])
        elseif cond ==2
            saveas(f5,[plot_save_location 'correct_wpli_parietal.png'])
        elseif cond ==3
            saveas(f5,[plot_save_location 'diff_wpli_parietal.png'])
        end
        ...
        set(gca, 'FontName','Arial', 'FontSize', 14)
        if cond == 1
            saveas(f6,[plot_save_location 'error_wpli_parietal_topo.png'])
        elseif cond ==2
            saveas(f6,[plot_save_location 'correct_wpli_parietal_topo.png'])
        elseif cond ==3
            saveas(f6,[plot_save_location 'diff_wpli_parietal_topo.png'])
        end
    end %end loop through conditions
else
end
...
if wPLI_calc==1
    for cond=1:length(ConditionNames)
        ...
        if cond == 1
            saveas(f5,[plot_save_location 'error_wpli_lateral_frontal.png'])
        elseif cond ==2
            saveas(f5,[plot_save_location 'correct_wpli_lateral_frontal.png'])
        elseif cond ==3
            saveas(f5,[plot_save_location 'diff_wpli_lateral_frontal.png'])
        end
        ...
        set(gca, 'FontName','Arial', 'FontSize', 14)
        if cond == 1
            saveas(f6,[plot_save_location 'error_wpli_lateral_frontal_topo.png'])
        elseif cond ==2
            saveas(f6,[plot_save_location 'correct_wpli_lateral_frontal_topo.png'])
        elseif cond ==3
            saveas(f6,[plot_save_location 'diff_wpli_lateral_frontal_topo.png'])
        end
    end %end loop through conditions
else
end
