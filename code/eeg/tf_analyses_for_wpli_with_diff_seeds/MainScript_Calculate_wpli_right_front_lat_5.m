...
save_location = [main_dir filesep 'derivatives' filesep 'preprocessed' filesep 'eeg' filesep 'wpli_outputs' filesep 'right_front_lat' filesep 'main' filesep ];

%3. Scripts Location
scripts_location = [main_dir filesep 'code' filesep 'eeg' filesep 'tf_analyses_for_wpli_with_diff_seeds'];
...
for sub=71:92 %length(subject_list)
