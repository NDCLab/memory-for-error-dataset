...
proc_fileName <- "processed_data_mfe_b_Proj_n6.csv" # output filename
...
hist_plot_output_path <- paste(proje_wd, "derivatives", "preprocessed", "psychopy", "alt5_histograms", sep ="/", collapse = NULL)
...
main_df <- setNames(data.frame(matrix(ncol = 32, nrow = 0)), c("participant_id", "congAcc", "incongAcc",
                                                               ...
                                                               "current_error_HR", "current_correct_HR", "current_diff_HR"))
        ...
        if (confidency_counts[[1]] < 346 ){
          ...
          if (nrow(legit_error_incong_flankerDat) >= 8 ){
            ...
            if (num_incong_error_faces_in_surp >= 8){
              ...
              # Find the new boundary based on which we will compute the hit rate for each participant
