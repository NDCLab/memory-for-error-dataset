...
# This version computes average confidence ratings. We exclude subjects based on overall dPrime in this version.
...
proc_fileName <- "processed_data_mfe_b_Proj_n7b.csv" # output filename
...
main_df <- setNames(data.frame(matrix(ncol = 38, nrow = 0)), c("participant_id", "congAcc", "incongAcc",
                                                               ...
                                                               "avg_confidence_correct_hitFaces", "avg_confidence_correct_missFaces", "avg_confidence_diff_allFaces", "avg_confidence_error_allFaces", "avg_confidence_correct_allFaces", "overall_dPrime"))
            ...
            if (num_incong_error_faces_in_surp >= 8){
              ...
              if (overall_dPrime > 0.2){
                ...
                main_df[nrow(main_df) + 1,] <-c(participant_id, congAcc, incongAcc,
                                                ...
                                                avg_confidence_diff_allFaces, avg_confidence_error_allFaces, avg_confidence_correct_allFaces, overall_dPrime)
