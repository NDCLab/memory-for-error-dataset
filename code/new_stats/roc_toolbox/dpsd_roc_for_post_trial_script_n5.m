...
saveDir = fullfile(mainDir,'derivatives', 'preprocessed', 'roc_dat', 'dpsd_n5', 'post_trial');
% 
roc_startup
%% Load the data
rawData = roc_import_data('/Users/kihossei/Documents/GitHub/memory-for-error-dataset/derivatives/preprocessed/organized_csvDat_for_roc_toolbox/longDat_post_trial_n5_without_headers.csv');
