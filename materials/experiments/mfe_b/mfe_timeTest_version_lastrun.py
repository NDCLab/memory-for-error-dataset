...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\NDClab\\Desktop\\Experiments\\mfe_b\\mfe_timeTest_version_lastrun.py',
    ...
    for thisPrac_trial_loop in prac_trial_loop:
        ...
        while continueRoutine:
            ...
            if bigFace.status == STARTED:
                # is it time to stop? (based on global clock, using actual start)
                if tThisFlipGlobal > bigFace.tStartRefresh + 1-frameTolerance:
                    # keep track of stop time/frame for later
