...
%% After creating a list of all faces, randomly sample 320 faces for 10 blocks. 320 is the number of trials. We also select additional 20 faces as practice trials.
% So, we load 340 faces in total.
...
% As we will show 50% foils, we will need to randomly select 320/2 faces
...
% "surp_list_Table"!
half_surp_table1 = surp_list_Table(1:240,1);
writetable(half_surp_table1, "half_surp_table1.csv")

half_surp_table2 = surp_list_Table(241:480,1);
