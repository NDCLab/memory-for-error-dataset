...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/kihossei/Documents/GitHub/memory-for-error-dataset/materials/experiments/mfeFlanker/mfe_timeTest_version_lastrun.py',
...
ringBell_text = visual.TextStim(win=win, name='ringBell_text',
    text='Ring the bell to let the experimenter that you finished the practice.',
    font='Open Sans',
...
instruct_surprise1 = visual.TextStim(win=win, name='instruct_surprise1',
    text='You will now begin a task in which you will be asked two questions.\n\nAnswers of these questions are presented on a slider and you will need to use the mouse to select one of them as your response. \n \n\nTo learn about this task and the questions, press the right button to continue. \n',
    font='Open Sans',
...
# --- Initialize components for Routine "surpIns3" ---
instruct_surprise1_6 = visual.TextStim(win=win, name='instruct_surprise1_6',
    text='The other question asks you whether the displayed face on screen looks Approving (showing satisfaction and positive opinion) or Disapproving (showing dissatisfaction and negative opinion).\n\nYou have six options: “definitely Approving”, “probably Approving”, “maybe Approving”, “maybe Disapproving”, “probably Disapproving” or “definitely Disapproving”.\n\nRandomly choose a response from the slider below to learn about these answers.',
    font='Open Sans',
    pos=(0, 0), height=0.03, wrapWidth=None, ori=0.0, 
    color='white', colorSpace='rgb', opacity=None, 
    languageStyle='LTR',
    depth=0.0);
prac_secSlider = visual.Slider(win=win, name='prac_secSlider',
    startValue=None, size=(0.85, 0.022), pos=(0, -0.35), units=None,
    labels=["Definitely", "Probably", "Maybe", "Maybe", "Probably", "Definitely"], ticks=[1, 2, 3, 4, 5, 6], granularity=1.0,
    style='rating', styleTweaks=(), opacity=None,
    labelColor='LightGray', markerColor='Red', lineColor='White', colorSpace='rgb',
...
# --- Initialize components for Routine "surpIns3_2" ---
instruct_surprise1_8 = visual.TextStim(win=win, name='instruct_surprise1_8',
    text='For example, if you are 100% confident that the face looks like a person who has a positive opinion, choose “definitely Approving”.\n\nIf you are less confident, but think probably that the face looks like a person who has a positive opinion, choose “probably Approving”.\n\nIf you really aren’t sure, but think it’s a little more likely that the face looks like a person who has a positive opinion, choose “maybe Approving”.\n\nIf you really aren’t sure, but think it’s a little more likely that the face looks like a person who has a negative opinion, choose “maybe Disapproving”.\n\nIf you aren’t certain, but think you probably that the face looks like a person who has a negative opinion, choose “probably Disapproving”.\n\nIf you are 100% confident that the face looks like a person who has a negative opinion, choose “definitely Disapproving”.\n\nRandomly choose a response from the slider below to proceed.',
    font='Open Sans',
    pos=(0, 0), height=0.03, wrapWidth=None, ori=0.0, 
    color='white', colorSpace='rgb', opacity=None, 
    languageStyle='LTR',
    depth=0.0);
prac_secSlider_2 = visual.Slider(win=win, name='prac_secSlider_2',
    startValue=None, size=(0.85, 0.022), pos=(0, -0.35), units=None,
    labels=["Definitely", "Probably", "Maybe", "Maybe", "Probably", "Definitely"], ticks=[1, 2, 3, 4, 5, 6], granularity=1.0,
    style='rating', styleTweaks=(), opacity=None,
    labelColor='LightGray', markerColor='Red', lineColor='White', colorSpace='rgb',
...
firstStim_sliderA1 = visual.Slider(win=win, name='firstStim_sliderA1',
    startValue=None, size=(0.85, 0.022), pos=(0, 0.3), units=None,
    labels=["Definitely", "Probably", "Maybe", "Maybe", "Probably", "Definitely"], ticks=[1, 2, 3, 4, 5, 6], granularity=1.0,
    style='rating', styleTweaks=(), opacity=None,
    labelColor='LightGray', markerColor='Red', lineColor='White', colorSpace='rgb',
    font='Open Sans', labelHeight=0.022,
...
text = visual.TextStim(win=win, name='text',
    text='',
    font='Open Sans',
    pos=(-0.6, 0.3), height=0.045, wrapWidth=None, ori=0.0, 
    color='white', colorSpace='rgb', opacity=None, 
    languageStyle='LTR',
    depth=-8.0);
...
# --- Initialize components for Routine "fixationA" ---
face_stimA = visual.ImageStim(
    win=win,
    name='face_stimA', units='height', 
    image='sin', mask=None, anchor='center',
    ori=0.0, pos=(0, 0), size=(0.4551466688, 0.32),
    color=[1,1,1], colorSpace='rgb', opacity=None,
    flipHoriz=False, flipVert=False,
...
secondStim_sliderA1 = visual.Slider(win=win, name='secondStim_sliderA1',
    startValue=None, size=(0.85, 0.022), pos=(0, -0.27), units=None,
    labels=["Definitely", "Probably", "Maybe", "Maybe", "Probably", "Definitely"], ticks=[1, 2, 3, 4, 5, 6], granularity=1.0,
    style='rating', styleTweaks=(), opacity=None,
    labelColor='LightGray', markerColor='Red', lineColor='White', colorSpace='rgb',
    font='Open Sans', labelHeight=0.022,
...
text_3 = visual.TextStim(win=win, name='text_3',
    text='',
    font='Open Sans',
    pos=(-0.6, -0.27), height=0.045, wrapWidth=None, ori=0.0, 
    color='white', colorSpace='rgb', opacity=None, 
    languageStyle='LTR',
    depth=-7.0);
...
image_fixation2 = visual.ImageStim(
    win=win,
    name='image_fixation2', 
    image='img/fixationCross.png', mask=None, anchor='center',
    ori=0.0, pos=(0, 0), size=(0.035, 0.035),
    color=[1,1,1], colorSpace='rgb', opacity=None,
    flipHoriz=False, flipVert=False,
    texRes=128.0, interpolate=True, depth=-1.0)
...
ringBell_text_4 = visual.TextStim(win=win, name='ringBell_text_4',
    text='Ring the bell to let the experimenter know completed the game.',
    font='Open Sans',
    pos=(0, 0), height=0.05, wrapWidth=None, ori=0.0, 
    color='white', colorSpace='rgb', opacity=None, 
    languageStyle='LTR',
...
# --- Prepare to start Routine "surpIns3" ---
continueRoutine = True
routineForceEnded = False
# update component parameters for each repeat
prac_secSlider.reset()
text_11.setText('Approving')
text_13.setText('Disapproving')
# keep track of which components have finished
surpIns3Components = [instruct_surprise1_6, prac_secSlider, text_11, text_13]
for thisComponent in surpIns3Components:
    thisComponent.tStart = None
    thisComponent.tStop = None
    thisComponent.tStartRefresh = None
    thisComponent.tStopRefresh = None
...
while continueRoutine:
    ...
    # *instruct_surprise1_6* updates
    if instruct_surprise1_6.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
        # keep track of start time/frame for later
        instruct_surprise1_6.frameNStart = frameN  # exact frame index
        instruct_surprise1_6.tStart = t  # local t and not account for scr refresh
        instruct_surprise1_6.tStartRefresh = tThisFlipGlobal  # on global time
        win.timeOnFlip(instruct_surprise1_6, 'tStartRefresh')  # time at next scr refresh
        # add timestamp to datafile
        thisExp.timestampOnFlip(win, 'instruct_surprise1_6.started')
        instruct_surprise1_6.setAutoDraw(True)
    
    # *prac_secSlider* updates
    if prac_secSlider.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
        # keep track of start time/frame for later
        prac_secSlider.frameNStart = frameN  # exact frame index
        prac_secSlider.tStart = t  # local t and not account for scr refresh
        prac_secSlider.tStartRefresh = tThisFlipGlobal  # on global time
        win.timeOnFlip(prac_secSlider, 'tStartRefresh')  # time at next scr refresh
        # add timestamp to datafile
        thisExp.timestampOnFlip(win, 'prac_secSlider.started')
        prac_secSlider.setAutoDraw(True)
    
    # Check prac_secSlider for response to end routine
    if prac_secSlider.getRating() is not None and prac_secSlider.status == STARTED:
        continueRoutine = False
...
# --- Ending Routine "surpIns3" ---
for thisComponent in surpIns3Components:
    if hasattr(thisComponent, "setAutoDraw"):
        thisComponent.setAutoDraw(False)
thisExp.addData('prac_secSlider.response', prac_secSlider.getRating())
thisExp.addData('prac_secSlider.rt', prac_secSlider.getRT())
# the Routine "surpIns3" was not non-slip safe, so reset the non-slip timer
routineTimer.reset()

# --- Prepare to start Routine "surpIns3_2" ---
continueRoutine = True
routineForceEnded = False
# update component parameters for each repeat
prac_secSlider_2.reset()
text_12.setText('Disapproving')
text_14.setText('Approving')
# keep track of which components have finished
surpIns3_2Components = [instruct_surprise1_8, prac_secSlider_2, text_12, text_14]
for thisComponent in surpIns3_2Components:
    thisComponent.tStart = None
    thisComponent.tStop = None
    thisComponent.tStartRefresh = None
    thisComponent.tStopRefresh = None
...
while continueRoutine:
    ...
    # *instruct_surprise1_8* updates
    if instruct_surprise1_8.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
        # keep track of start time/frame for later
        instruct_surprise1_8.frameNStart = frameN  # exact frame index
        instruct_surprise1_8.tStart = t  # local t and not account for scr refresh
        instruct_surprise1_8.tStartRefresh = tThisFlipGlobal  # on global time
        win.timeOnFlip(instruct_surprise1_8, 'tStartRefresh')  # time at next scr refresh
        # add timestamp to datafile
        thisExp.timestampOnFlip(win, 'instruct_surprise1_8.started')
        instruct_surprise1_8.setAutoDraw(True)
    
    # *prac_secSlider_2* updates
    if prac_secSlider_2.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
        # keep track of start time/frame for later
        prac_secSlider_2.frameNStart = frameN  # exact frame index
        prac_secSlider_2.tStart = t  # local t and not account for scr refresh
        prac_secSlider_2.tStartRefresh = tThisFlipGlobal  # on global time
        win.timeOnFlip(prac_secSlider_2, 'tStartRefresh')  # time at next scr refresh
        # add timestamp to datafile
        thisExp.timestampOnFlip(win, 'prac_secSlider_2.started')
        prac_secSlider_2.setAutoDraw(True)
    
    # Check prac_secSlider_2 for response to end routine
    if prac_secSlider_2.getRating() is not None and prac_secSlider_2.status == STARTED:
        continueRoutine = False
...
# --- Ending Routine "surpIns3_2" ---
for thisComponent in surpIns3_2Components:
    if hasattr(thisComponent, "setAutoDraw"):
        thisComponent.setAutoDraw(False)
thisExp.addData('prac_secSlider_2.response', prac_secSlider_2.getRating())
thisExp.addData('prac_secSlider_2.rt', prac_secSlider_2.getRT())
# the Routine "surpIns3_2" was not non-slip safe, so reset the non-slip timer
routineTimer.reset()
...
for thisSurprise_block_loop in surprise_block_loop:
    ...
    for thisTrial in trials:
        ...
        for thisTrial_2 in trials_2:
            ...
            # Run 'Begin Routine' code from slider_trig_code
            resp_triggerSentZ1 = False
            # Run 'Begin Routine' code from response_trigger_code_3
            
            #already within a given trial.
            
            resp_triggerSent = False
            ...
            while continueRoutine:
                ...
                if firstStim_sliderA1.getRating() is not None and firstStim_sliderA1.status == STARTED:
                    continueRoutine = False
                # Run 'Each Frame' code from slider_trig_code
                if firstStim_sliderA1.getRating() is not None and not resp_triggerSent:
            ...
            # Run 'End Routine' code from response_trigger_code_3
            ...
            # --- Prepare to start Routine "fixationA" ---
            continueRoutine = True
            routineForceEnded = False
            # update component parameters for each repeat
            # Run 'Begin Routine' code from code_21
            # make range from a to b in n stepsizes
            ISIRange2 = np.linspace(1000, 1500, 500)
            
            # picking from a shuffled array is easier for random selection in JS
            shuffle(ISIRange2)
            thisISI2 = ISIRange2[0]/1000 # the first item of the shuffled array 
            
            face_stimA.setImage('img/leftArrow.png')
            # keep track of which components have finished
            fixationAComponents = [face_stimA]
            for thisComponent in fixationAComponents:
                thisComponent.tStart = None
                thisComponent.tStop = None
                thisComponent.tStartRefresh = None
                thisComponent.tStopRefresh = None
            ...
            while continueRoutine:
                ...
                # *face_stimA* updates
                if face_stimA.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                    # keep track of start time/frame for later
                    face_stimA.frameNStart = frameN  # exact frame index
                    face_stimA.tStart = t  # local t and not account for scr refresh
                    face_stimA.tStartRefresh = tThisFlipGlobal  # on global time
                    win.timeOnFlip(face_stimA, 'tStartRefresh')  # time at next scr refresh
                    # add timestamp to datafile
                    thisExp.timestampOnFlip(win, 'face_stimA.started')
                    face_stimA.setAutoDraw(True)
                if face_stimA.status == STARTED:
                    # is it time to stop? (based on global clock, using actual start)
                    if tThisFlipGlobal > face_stimA.tStartRefresh + thisISI2-frameTolerance:
                        # keep track of stop time/frame for later
                        face_stimA.tStop = t  # not accounting for scr refresh
                        face_stimA.frameNStop = frameN  # exact frame index
                        # add timestamp to datafile
                        thisExp.timestampOnFlip(win, 'face_stimA.stopped')
                        face_stimA.setAutoDraw(False)
            ...
            # --- Ending Routine "fixationA" ---
            for thisComponent in fixationAComponents:
                if hasattr(thisComponent, "setAutoDraw"):
                    thisComponent.setAutoDraw(False)
            # the Routine "fixationA" was not non-slip safe, so reset the non-slip timer
            routineTimer.reset()
            ...
            sStimA1.setPos((0, -0.2))
            sStimA1.setText(secondTextA)
            sStimA1.setHeight(0.045)
            # Run 'Begin Routine' code from stimulus_trig_code_7
            #set stimTriggerSent to false at the start of the trial. this way
            #when the stimulus is shown, we can change it to True. This variable
            #is used to ensure we only throw the stimulus EEG trigger once.
            stimulusTriggerSent = False
            secondStim_sliderA1.reset()
            # Run 'Begin Routine' code from response_trigger_code_7
            ...
            sec_mouseA1.setPos([0, 0.4])
            text_3.setText(secondLeft)
            text_4.setText(secondRight)
            # keep track of which components have finished
            secondStim_A1Components = [second_surpStimuliA1, sStimA1, secondStim_sliderA1, sec_mouseA1, text_3, text_4]
            ...
            while continueRoutine:
                ...
                # Run 'Each Frame' code from stimulus_trig_code_7
                
                if second_surpStimuliA1.status == STARTED and not stimulusTriggerSent:
                    stimulusTriggerSent = True #switch stimTriggerSent to True so that the stimulus eeg trigger will not be sent again this trial
                    port.write([0x20]) #hexcode = 32; eeg trigger sent
                    time.sleep(PulseWidth) #how long to wait before clearing trigger port
                    port.write([0x00]) #clear trigger port by sending hexcode = 0
                ...
                if secondStim_sliderA1.getRating() is not None and secondStim_sliderA1.status == STARTED:
                    continueRoutine = False
                # Run 'Each Frame' code from response_trigger_code_7
                if secondStim_sliderA1.getRating() is not None and not resp_triggerSent:
                    if secondStim_sliderA1.getRating() == 1:
                        port.write([0x33]) # 51
                        time.sleep(PulseWidth)
                        port.write([0x00])
                        resp_triggerSent = True
                        ...
                        port.write([0x00])
                        resp_triggerSent = True
                    elif secondStim_sliderA1.getRating() == 3: 
                        port.write([0x35])# 53
                        time.sleep(PulseWidth)
                        port.write([0x00])
                        resp_triggerSent = True
                    elif secondStim_sliderA1.getRating() == 4: 
                        port.write([0x36])# 54
                        time.sleep(PulseWidth)
                        port.write([0x00])
                        resp_triggerSent = True
                    elif secondStim_sliderA1.getRating() == 5: 
                        port.write([0x37])# 55
                        time.sleep(PulseWidth)
                        port.write([0x00])
                        resp_triggerSent = True
                    elif secondStim_sliderA1.getRating() == 6: 
                        port.write([0x38])# 56
                        time.sleep(PulseWidth)
                        port.write([0x00])
                        resp_triggerSent = True
            ...
            # Run 'End Routine' code from response_trigger_code_7
            ...
            event.clearEvents()
            # make range from a to b in n stepsizes
            ISIRange3 = np.linspace(1000, 1500, 500)
            ...
            # keep track of which components have finished
            fixation2Components = [image_fixation2]
            ...
            while continueRoutine:
                ...
                # *image_fixation2* updates
                if image_fixation2.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                    # keep track of start time/frame for later
                    image_fixation2.frameNStart = frameN  # exact frame index
                    image_fixation2.tStart = t  # local t and not account for scr refresh
                    image_fixation2.tStartRefresh = tThisFlipGlobal  # on global time
                    win.timeOnFlip(image_fixation2, 'tStartRefresh')  # time at next scr refresh
                    # add timestamp to datafile
                    thisExp.timestampOnFlip(win, 'image_fixation2.started')
                    image_fixation2.setAutoDraw(True)
                if image_fixation2.status == STARTED:
                    # is it time to stop? (based on global clock, using actual start)
                    if tThisFlipGlobal > image_fixation2.tStartRefresh + thisISI3-frameTolerance:
                        # keep track of stop time/frame for later
                        image_fixation2.tStop = t  # not accounting for scr refresh
                        image_fixation2.frameNStop = frameN  # exact frame index
                        # add timestamp to datafile
                        thisExp.timestampOnFlip(win, 'image_fixation2.stopped')
                        image_fixation2.setAutoDraw(False)
                # Run 'Each Frame' code from fixation_trig
                
                if image_fixation2.status == STARTED and not stimulusTriggerSentQ1:
