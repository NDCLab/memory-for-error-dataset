...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\NDClab\\Desktop\\Experiments\\memory_for_error_flanker\\memory_for_error_flanker_lastrun.py',
...
instruct_surprise1_8 = visual.TextStim(win=win, name='instruct_surprise1_8',
    text='For example, if you are 100% confident that the face looks approving (showing positive opinion), choose “definitely Approving”.\n\nIf you are less confident, but think probably that the face looks approving (showing positive opinion), choose “probably Approving”.\n\nIf you really aren’t sure, but think it’s a little more likely that the face looks approving (showing positive opinion), choose “maybe Approving”.\n\nIf you really aren’t sure, but think it’s a little more likely that the face looks disapproving (showing negative opinion), choose “maybe Disapproving”.\n\nIf you aren’t certain, but think probably that the face looks disapproving (showing negative opinion), choose “probably Disapproving”.\n\nIf you are 100% confident that the face looks disapproving (showing negative opinion), choose “definitely Disapproving”.\n\nRandomly choose a response from the slider below to proceed.',
    font='Open Sans',
    pos=(0, 0), height=0.03, wrapWidth=None, ori=0.0, 
    color='white', colorSpace='rgb', opacity=None, 
    languageStyle='LTR',
...
text_11.setText(Left_sec_inst)
text_13.setText(Right_sec_inst)
# keep track of which components have finished
...
text_12.setText(Left_sec_inst)
text_14.setText(Right_sec_inst)
# keep track of which components have finished
...
for thisSurprise_block_loop in surprise_block_loop:
    ...
    for thisTrial in trials:
        ...
        for thisTrial_2 in trials_2:
            ...
            face_stimA.setImage(surpriseFaces)
            # keep track of which components have finished
            ...
            while continueRoutine:
                ...
                if secondStim_sliderA1.getRating() is not None and not resp_triggerSentQ2:
                    if secondStim_sliderA1.getRating() == 1:
                        port.write([0x33]) # 51
                        time.sleep(PulseWidth)
                        port.write([0x00])
                        resp_triggerSentQ2 = True
                    elif firstStim_sliderA1.getRating() == 2: 
                        port.write([0x34])# 52
                        time.sleep(PulseWidth)
                        port.write([0x00])
