...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/khoss005/Library/CloudStorage/OneDrive-FloridaInternationalUniversity/Projects/Psychopy/half_mfeFlanker_version/halfVfaceFlanker_v1_lastrun.py',
...
for thisFriendly_block_loop in friendly_block_loop:
    ...
    for thisTrial_2 in trials_2:
        ...
        # keep track of which components have finished
        friendlyTaskComponents = [stimulus_2, instructsurpA1_right_2, instructsurpA2_left_2, surprise_key_resp_2]
