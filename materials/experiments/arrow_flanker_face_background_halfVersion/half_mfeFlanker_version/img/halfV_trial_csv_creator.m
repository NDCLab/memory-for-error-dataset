...
main_dir = '/Users/khoss005/Library/CloudStorage/OneDrive-FloridaInternationalUniversity/Projects/Psychopy/half_mfeFlanker_version/img';
...
for jaguar=1:7 % 12 of these files will be for the main blocks. The last one with 20 trials will be the practice block.
    if jaguar==7
        ...
        for zebra=1:length(rightCong)
            ...
            rightCong(zebra,11)= '[.03, .03]'; % Size for the image
        end
        ...
        % The first 6 files will be used for the arrow flanker task in the alternative task.
