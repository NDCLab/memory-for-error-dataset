...
for thisSurprise_block_loop in surprise_block_loop:
    ...
    for thisTrial in trials:
        ...
        trials.addData('firstQ.started', firstQ.tStartRefresh)
        trials.addData('firstQ.stopped', firstQ.tStopRefresh)
        trials.addData('first_slider.response', first_slider.getRating())
        trials.addData('first_slider.rt', first_slider.getRT())
        trials.addData('first_slider.started', first_slider.tStartRefresh)
        trials.addData('first_slider.stopped', first_slider.tStopRefresh)
        ...
        continueRoutine = True
        # update component parameters for each repeat
        stimulus12_2.setImage(surpriseFaces[-1])
        ...
        for thisComponent in fr_task1Components:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        trials.addData('stimulus12_2.started', stimulus12_2.tStartRefresh)
        trials.addData('stimulus12_2.stopped', stimulus12_2.tStopRefresh)
        trials.addData('secondQ_2.started', secondQ_2.tStartRefresh)
        trials.addData('secondQ_2.stopped', secondQ_2.tStopRefresh)
        # check responses
        if friendly_key_resp_3.keys in ['', [], None]:  # No response was made
            friendly_key_resp_3.keys = None
        trials.addData('friendly_key_resp_3.keys',friendly_key_resp_3.keys)
        if friendly_key_resp_3.keys != None:  # we had a response
            trials.addData('friendly_key_resp_3.rt', friendly_key_resp_3.rt)
        trials.addData('friendly_key_resp_3.started', friendly_key_resp_3.tStartRefresh)
        trials.addData('friendly_key_resp_3.stopped', friendly_key_resp_3.tStopRefresh)
