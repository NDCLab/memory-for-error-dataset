...
for thisSurprise_block_loop in surprise_block_loop:
    ...
    for thisTrial in trials:
        ...
        for thisTrial_3 in trials_3:
            ...
            trials_3.addData('surprise_key_resp.keys',surprise_key_resp.keys)
            if surprise_key_resp.keys != None:  # we had a response
                trials_3.addData('surprise_key_resp.rt', surprise_key_resp.rt)
            ...
            # keep track of which components have finished
            friendlyTaskComponents = [instructsurpA1_right_2, instructsurpA2_left_2, friendly_key_resp]
            ...
            while continueRoutine:
                ...
                if instructsurpA1_right_2.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                    ...
                    # add timestamp to datafile
                    thisExp.timestampOnFlip(win, 'instructsurpA1_right_2.started')
                ...
                if instructsurpA2_left_2.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                    ...
                    # add timestamp to datafile
                    thisExp.timestampOnFlip(win, 'instructsurpA2_left_2.started')
                ...
                if friendly_key_resp.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                    ...
                    # add timestamp to datafile
                    thisExp.timestampOnFlip(win, 'friendly_key_resp.started')
...
while continueRoutine:
    ...
    if instruct_surprise1_2.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
        ...
        # add timestamp to datafile
        thisExp.timestampOnFlip(win, 'instruct_surprise1_2.started')
...
for thisFriendly_block_loop in friendly_block_loop:
    ...
    while continueRoutine:
        ...
        if instructMainTask_text_2.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            ...
            # add timestamp to datafile
            thisExp.timestampOnFlip(win, 'instructMainTask_text_2.started')
        ...
        if instructMainTask_keyResp_2.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            ...
            # add timestamp to datafile
            thisExp.timestampOnFlip(win, 'instructMainTask_keyResp_2.started')
