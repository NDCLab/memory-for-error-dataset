%% This script is written by Kianoosh Hosseini at NDClab (See https://Kianoosh.info and https://ndclab.com) in June. 2022.
%%% For Chicago faces ...
...
main_dir = '/Users/kihossei/Documents/GitHub/memory-for-error-dataset/materials/experiments/memory-for-error-o_s1_r1_e1/img';
...
%% After creating a list of all faces, randomly sample 340 faces. 320 is the number of trials. We also select additional 20 faces as practice trials.
% So, we load 212 faces in total.
faces = randsample(allFaces, 340);
...
surpriseFaces = randsample(surpriseFaces, 320/2);
...
for jaguar=1:11 % 10 of these files will be for the main blocks. The last one with 20 trials will be the practice block.
    if jaguar==11
        ...
        % The first 10 csv files will be used for the arrow flanker task in the alternative task.
